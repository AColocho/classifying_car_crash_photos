from . import main
from flask import redirect, render_template, url_for,request, make_response, current_app, session
...
def results():
    ...
    if L.CheckEmpty():
        ...
        predictions = 'Accident: {}% No Accident: {}%.'.format(preds_perct[0],preds_perct[1])
